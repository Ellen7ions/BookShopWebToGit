...
<div class="container">
    <%
        if (request.getAttribute("loginNoUser") != null) {
    %>
    <div class="alert alert-danger">
        <strong>登陆失败！</strong> 账户不存在，请注册！
    </div>
    <%
            request.removeAttribute("loginNoUser");
        }
    %>
                ...
                <div class="r ow my-form">
                    <div class="container">
                        <form action="./RegisterPost" method="post" onsubmit="check(this)">
                            ...
                            <div class="row my-block-2"></div>

                            <div id="btn-outer" align="center">
                                <button type="submit" class="btn-block btn btn-primary">确认注册</button>
                            </div>
                        </form>
                    </div>
                </div>
